...
sed -i 's/magisk_ver=.*"/magisk_ver="20.4"/g' /etc/init.d/42mad
sed -i 's@url_magisk=.*"@url_magisk="https://github.com/topjohnwu/Magisk/releases/download/v20.4/Magisk-v20.4.zip"@g' /etc/init.d/42mad
check_magisk
