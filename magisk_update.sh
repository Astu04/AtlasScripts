...
#magisk version / url
magisk_ver="25.1"
url_magisk="https://github.com/topjohnwu/Magisk/releases/download/v25.1/Magisk-v25.1.apk"
...
sed -i 's/magisk_ver=.*"/magisk_ver="25.1"/g' /etc/init.d/42mad
sed -i 's@url_magisk=.*"@url_magisk="https://github.com/topjohnwu/Magisk/releases/download/v25.1/Magisk-v25.1.apk"@g' /etc/init.d/42mad
check_magisk
